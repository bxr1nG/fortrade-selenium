...
### 6 *Проверка ставок в резюме*

| Название                                              | Описание                                                     |
| ----------------------------------------------------- | ------------------------------------------------------------ |
| **Номер тест-кейса**                                  | 6                                                            |
| **Заголовок**                                         | Проверка ставок в резюме                                     |
| **Предусловие**                                       | Открыта страница [Home](https://ready.fortrade.com/#home), реализован вход в аккаунт, открыта вкладка "AUD/CAD" в области графиков |
| **Шаг**                                               | **Ожидаемый результат**                                      |
| В заголовке открытого графика нажать кнопку "Купить"  | Открылось окно "AUD/CAD"                                     |
| В поле "Сумма" ввести 1000 и нажать Enter             | Поле "Сумма" содержит текст "1,000", внизу окна появилась надпись "Вы собираетесь КУПИТЬ AUD/CAD в размере 1,000 AUD" |
| Нажать кнопку "Купить сейчас"                         | Окно закрылось, появилось всплывающее окно "Вы купили 1,000 AUD/CAD по цене  0.92055", в нижнем меню страницы во вкладке "Открыть сделку" появилась запись о новой сделке. |
| В заголовке открытого графика нажать кнопку "Продать" | Открылось окно "AUD/CAD"                                     |
| В поле "Сумма" ввести 1000 и нажать Enter             | Поле "Сумма" содержит текст "1,000", внизу окна появилась надпись "Вы собираетесь КУПИТЬ AUD/CAD в размере 1,000 AUD" |
| Нажать кнопку "Продать сейчас"                        | Окно закрылось, появилось всплывающее окно "Вы продали 1,000 AUD/CAD по цене  0.91235", в нижнем меню страницы во вкладке "Открыть сделку" появилась запись о новой сделке |
| Нажать на вкладку "Резюме" в нижнем меню страницы     | Открылась вкладка "Резюме" с одной записью "AUD/CAD" и информацией об открытых сделках в ней |



### 7 *Дублирование сделки*

| Название                                                     | Описание                                                     |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Номер тест-кейса**                                         | 7                                                            |
| **Заголовок**                                                | Дублирование сделки                                          |
| **Предусловие**                                              | Открыта страница [Home](https://ready.fortrade.com/#home), реализован вход в аккаунт, открыта вкладка "AUD/CAD" в области графиков |
| **Шаг**                                                      | **Ожидаемый результат**                                      |
| В заголовке открытого графика нажать кнопку "Купить"         | Открылось окно "AUD/CAD"                                     |
| В поле "Сумма" ввести 1000 и нажать Enter                    | Поле "Сумма" содержит текст "1,000", внизу окна появилась надпись "Вы собираетесь КУПИТЬ AUD/CAD в размере 1,000 AUD" |
| Нажать кнопку "Купить сейчас"                                | Окно закрылось, появилось всплывающее окно "Вы купили 1,000 AUD/CAD по цене  0.92055", в нижнем меню страницы во вкладке "Открыть сделку" появилась запись о новой сделке. |
| В нижнем меню на вкладке "Открыть сделку" напротив записи о сделке нажать кнопку "Дублировать сделку" | Открылось окно "Дублировать сделку"                          |
| Нажать на кнопку "Купить" в окне                             | Окно закрылось, в области графика появилось всплывающее окно с текстом "Ваш запрос на открытие новой сделки успешно выполнен". В нижнем меню на вкладке "Открыть сделку" появилась новая запись, идентичная позицией и суммой с исходной |



### 8 *Открытие сделки на сумму больше баланса*
